...
const InterviewListing = () => {
  ...
  return (
    ...
    >
      <div className="mb-6 h-auto md:h-[15vh] flex flex-col md:flex-row items-start md:items-center rounded-xl p-4 bg-gray-700 space-y-4 md:space-y-0 md:space-x-4">
        {/* Title */}
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full md:w-auto">
          ...
          <div className="relative w-full sm:w-64">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-300 shadow-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500  transition-all duration-200"
            />
          </div>
          ...
          <button
            ...
            className="flex items-center justify-center px-4 py-2 bg-gray-700 text-white rounded-xl border border-white hover:bg-gray-600 transition-all duration-200 shadow-sm w-full sm:w-auto"
          >
            <span className="mr-2 font-bold text-lg">+</span>
            <span className="whitespace-nowrap">Add New Interview Round</span>
          </button>
        </div>
      </div>
