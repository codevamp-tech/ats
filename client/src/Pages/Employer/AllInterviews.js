          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-center space-y-4 md:space-y-0">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end gap-4 w-full md:w-auto">
              ...
              <div className="w-full sm:w-[300px]">
                <label className="block text-white text-xs font-bold mb-1">Search:</label>
                <form onSubmit={handleSearchSubmit} autoComplete="off">
                  <div className="relative rounded-full">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-10 py-2 border border-gray-300 shadow-sm rounded-xl focus:outline-none"
                    />
                    {searchTerm && (
                      <button
                        type="button"
              ...
              <div className="w-full sm:w-[200px] relative">
                <label className="block text-white text-xs font-bold mb-1">Filter by Status:</label>
                <select
                  className="w-full appearance-none bg-gray-200 rounded-xl py-2 pl-4 pr-10 focus:outline-none"
                  value={filterStatus}
                ...
                <div className="absolute inset-y-0 right-3 top-[2.5rem] flex items-center pointer-events-none">
