        ...
        <div className="py-24 bg-slate-900/50 backdrop-blur-sm">
            <div className="max-w-screen-xl mx-auto px-4">
                ...
                <div className="text-center mt-12">
                    ...
                    >
                        <button className="bg-white/10 hover:bg-white/20 text-white py-3 px-8 rounded-xl font-medium backdrop-blur-sm transition-all duration-300">
                            View All Jobs
                        </button>
                    </Link>
                </div>
            ...
            <div className="p-5">
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                        <Link to={`/${companyUserName}/login`} className="w-full sm:w-36 md:w-28">
                            <button className="w-full bg-purple-100 text-purple-700 px-4 py-2 rounded-xl hover:bg-purple-200 transition-colors text-sm">
                                View Details
                            </button>
                        </Link>

                        <Link to={`/${companyUserName}/login`} className="w-full sm:w-36 md:w-28">
                            <button className="w-full bg-purple-700 text-white px-4 py-2 rounded-xl hover:bg-purple-800 transition-colors text-sm">
                                Apply Now
                            </button>
                        </Link>
                    </div>
