        ...
        <div className="grid md:grid-cols-2 gap-8 items-center min-h-[80vh]">
            <div className="space-y-6 max-w-xl">
                ...
                <div className="flex flex-col sm:flex-row flex-wrap gap-4 pt-2">
                    <button className="w-full md:w-full sm:w-auto bg-indigo-600 hover:bg-indigo-700 text-white py-3 px-8 rounded-xl font-medium transition-all duration-300 shadow-lg shadow-indigo-600/30 flex items-center justify-center gap-2 ">
                        Get Started <ArrowRight size={18} />
                    </button>

                    <button className="w-full md:w-full sm:w-auto bg-white/10 hover:bg-white/20 text-white py-3 px-8 rounded-xl font-medium backdrop-blur-sm transition-all duration-300">
                        Book a Demo
                    </button>
                </div>
