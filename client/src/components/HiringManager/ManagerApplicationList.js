                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0 md:space-x-6">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-4 w-full md:w-auto">
                            ...
                            <div className="w-full sm:w-[300px]">
                                <label className="block text-white text-xs font-bold mb-1">Search by Status:</label>
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-4 py-2 border border-gray-300 shadow-sm rounded-xl focus:outline-none"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="w-full sm:w-[200px]">
                                <label className="block text-white text-xs font-bold mb-1">Filter by Job:</label>
                                <select
                                    className="w-full bg-gray-200 hover:bg-white rounded-xl py-2 px-4 focus:outline-none"
