                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-4 w-full md:w-auto">
                            ...
                            <div className="relative w-full sm:w-64">
                                ...
                                <input
                                    type="text"
                                    className="w-full pl-10 pr-2 py-2 border border-gray-300 rounded-xl bg-gray-50 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                            ...
                            {/* Icons */}
                            <div className="flex justify-start sm:justify-end items-center space-x-4 w-full sm:w-auto">
